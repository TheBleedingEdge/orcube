...
function HostUpload() {
  ...
  const submitPic = async event => {
    ...
    console.log(images);
    const { data } = await axios.post("http://127.0.0.1:5000/api/host/spaceuploadpic", formData, { headers: { 'Content-Type': 'multipart/form-data' } });
    if (data != null) {
  ...
  const submitData = async () => {
    ...
    dispatch(SpaceUpload(HostId, imageUrl, Title, Address, Discription, Price, isCheckedwifi, isCheckedparking, isCheckedtv, isCheckedkitchen, isCheckedentrance, countAdult, countChildren, countPets))
  }
  ...
  return (
    ...
    <div className="w-full mt-5 bg-slate-50 rounded-lg shadow-xl">
          ...
          <section className='mt-10'>
            <div className='flex'>
              ...
              <div className="ml-10 mb-4">
                <button onClick={() => setCountAdult((obj) => obj - 1)} className="btn btn-md bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <div className='flex'>
              ...
              <div className="ml-5 mb-4">
                <button onClick={() => setCountChildren((obj) => obj - 1)} className="btn btn-md bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6" />
                  </svg>
                </button>
            ...
            <div className='flex'>
              ...
              <div className="ml-12 mb-4">
                <button onClick={() => setCountPets((obj) => obj - 1)} className="btn btn-md bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M18 12H6" />
                  </svg>
                </button>
